  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-mini-app-background border-t border-grey-light z-40">
      <div className="flex items-center justify-around px-2 py-2">
        ...
        {/* Поиск */}
        <button className="flex flex-col items-center gap-1 px-3 py-2 text-grey hover:text-primary transition-colors">
        ...
        <button
          onClick={onAddClick}
          className="relative w-14 h-9 rounded-full bg-purple text-white shadow-lg hover:bg-purple/90 transition-all flex items-center justify-center"
        >
